...
class $AccountsTable extends Accounts with TableInfo<$AccountsTable, Account> {
  ...
  static const VerificationMeta _openingBalanceNatureMeta =
      const VerificationMeta('openingBalanceNature');
  @override
  late final GeneratedColumn<String> openingBalanceNature =
      GeneratedColumn<String>(
        'opening_balance_nature',
        aliasedName,
        false,
        type: DriftSqlType.string,
        requiredDuringInsert: false,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('opening_balance_nature')) {
      context.handle(
        _openingBalanceNatureMeta,
        openingBalanceNature.isAcceptableOrUnknown(
          data['opening_balance_nature']!,
          _openingBalanceNatureMeta,
        ),
      );
    }
  ...
  Account map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Account(
      ...
      openingBalanceNature: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}opening_balance_nature'],
      )!,
...
class Account extends DataClass implements Insertable<Account> {
  ...
  final String openingBalanceNature;
  ...
  const Account({
    ...
    required this.openingBalanceNature,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['opening_balance_nature'] = Variable<String>(openingBalanceNature);
  ...
  AccountsCompanion toCompanion(bool nullToAbsent) {
    return AccountsCompanion(
      ...
      openingBalanceNature: Value(openingBalanceNature),
  ...
  factory Account.fromJson(
    ...
    return Account(
      ...
      openingBalanceNature: serializer.fromJson<String>(
        json['openingBalanceNature'],
      ),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'openingBalanceNature': serializer.toJson<String>(openingBalanceNature),
  ...
  Account copyWith({
    ...
    openingBalanceNature: openingBalanceNature ?? this.openingBalanceNature,
  ...
  Account copyWithCompanion(AccountsCompanion data) {
    return Account(
      ...
      openingBalance: data.openingBalance.present
          ...
          : this.openingBalance,
      openingBalanceNature: data.openingBalanceNature.present
          ? data.openingBalanceNature.value
          : this.openingBalanceNature,
  ...
  String toString() {
    return (StringBuffer('Account(')
          ...
          ..write('openingBalanceNature: $openingBalanceNature, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is Account &&
          ...
          other.openingBalanceNature == this.openingBalanceNature &&
...
class AccountsCompanion extends UpdateCompanion<Account> {
  ...
  final Value<String> openingBalanceNature;
  ...
  const AccountsCompanion({
    ...
    this.openingBalanceNature = const Value.absent(),
  ...
  static Insertable<Account> custom({
    ...
    Expression<String>? openingBalanceNature,
  ...
  AccountsCompanion copyWith({
    ...
    Value<String>? openingBalanceNature,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (openingBalanceNature.present) {
      map['opening_balance_nature'] = Variable<String>(
        openingBalanceNature.value,
      );
    }
...
class $$AccountsTableFilterComposer
  ...
  ColumnFilters<String> get openingBalanceNature => $composableBuilder(
    column: $table.openingBalanceNature,
    builder: (column) => ColumnFilters(column),
  );
...
class $$AccountsTableOrderingComposer
  ...
  ColumnOrderings<String> get openingBalanceNature => $composableBuilder(
    column: $table.openingBalanceNature,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$AccountsTableAnnotationComposer
  ...
  GeneratedColumn<String> get openingBalanceNature => $composableBuilder(
    column: $table.openingBalanceNature,
    builder: (column) => column,
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String> openingBalanceNature = const Value.absent(),
